...
def plot_yearly(storm_counts, score_cols, xticklabels, df_ibtracs, plot_ibtracs=False):
    ...
    for year, yearly_data in storm_counts.groupby("Year"):
        ...
        plt.savefig(f"{CONFIG.POSTPROCESS.OUTPUT_FREQUENCY}/TCGfrequency_{year}.eps", bbox_inches='tight', format='eps')
        plt.savefig(f"{CONFIG.POSTPROCESS.OUTPUT_FREQUENCY}/TCGfrequency_{year}.pdf", bbox_inches='tight', format='pdf')
...
def plot_duration(storm_counts, score_cols, xticklabels, start_year, end_year, df_ibtracs, plot_ibtracs=False):
    ...
    plt.savefig(f"{CONFIG.POSTPROCESS.OUTPUT_FREQUENCY}/TCGfrequency_{start_year}_{end_year}.eps", bbox_inches='tight', format='eps')
    plt.savefig(f"{CONFIG.POSTPROCESS.OUTPUT_FREQUENCY}/TCGfrequency_{start_year}_{end_year}.pdf", bbox_inches='tight', format='pdf')
...
def main():
    ...
    ibtracs_folder = CONFIG.POSTPROCESS.IBTRACS_FOLDER
    ibtracs_file = None
    ...
    year_duration = CONFIG.POSTPROCESS.YEAR_DURATION
    plot_ibtracs = CONFIG.POSTPROCESS.PLOT_IBTRACS
    plot_duration_flag = CONFIG.POSTPROCESS.PLOT_DURATION
