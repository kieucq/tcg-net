...
class Model_result():
    ...
    def __init__(self,
        ...
        df_first = pd.read_csv('/N/u/tqluu/BigRed200/@PUBLIC/data_preprocessed/nasa-merra2/FIRST_MERRA2_IBTRACS.csv')
        ...
        df_full = pd.read_csv('/N/u/tqluu/BigRed200/@PUBLIC/data_preprocessed/nasa-merra2/FULL_MERRA2_IBTRACS.csv')
...
if __name__ == '__main__':
    ...
    csv_temp = '/N/slate/tnn3/DucHGA/TC/ModelMerra/Output/DynamicSingleRemain_percent/ResNet/Step_{}_v0/map_test.csv'
    ...
    for step in range(20):
        ...
        df = result.detection_acc(dt_list=[(datetime(2017, 5, 1), datetime(2017, 12, 1)),
    ...
    scoreboard.to_excel('/N/slate/tnn3/DucHGA/Zdetection_new.xlsx')
