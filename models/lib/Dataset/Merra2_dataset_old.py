...
if __name__ == '__main__':
    data = LData(DatasetClass=Merra2_full,
                      train_path='/N/slate/ckieu/typhoon-formation/output/csv/DynamicRemain_rus30/Step_2/train.csv',
                      val_path='/N/slate/ckieu/typhoon-formation/output/csv/DynamicRemain_rus30/Step_2/train.csv',
                      test_path='/N/slate/ckieu/typhoon-formation/output/csv/DynamicRemain_rus30/Step_2/train.csv',
                      predict_path='/N/slate/ckieu/typhoon-formation/output/csv/DynamicRemain_rus30/Step_2/train.csv')
