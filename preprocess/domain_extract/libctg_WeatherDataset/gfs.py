...
class Gfs(WeatherDataset):
    def __init__(self, min_lat: float = -50, max_lat: float = 70, step_lat: float = 0.5, dim_lat: int = 33, min_lon: float = 60, max_lon: float = 220, step_lon: float = 0.626, dim_lon: int = 33, step_time_hours: float = 6.0):
