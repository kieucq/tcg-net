...
Deep-learning reconstruction and prediction of tropical cyclogenesis in the Western North Pacific.

TCG-Net is a research pipeline for detecting favorable environments for tropical cyclone genesis (TCG) directly from gridded reanalysis, climate-model, and forecast data. The repository covers data standardization, construction of supervised positive/negative samples, training and fine-tuning of an adapted ResNet-18 classifier, sliding-window inference, and visualization of TCG probability maps and climatological frequency.

The scientific method and model design are described in:

> D.-T. Le et al., “Deep Learning Reconstruction of Tropical Cyclogenesis in the Western North Pacific from Climate Reanalysis Dataset,” 2025. [https://doi.org/10.48550/arXiv.2510.06118](https://doi.org/10.48550/arXiv.2510.06118)
...
### Indiana University HPC environment
...
### 3. Construct supervised domains for training
...
### 6. Fine-tune on another dataset
...
### 7. Reconstruct TCG fields from climate or reanalysis data
...
### 8. Run the end-to-end GFS operational workflow
...
Duc-Trong Le, Tran-Binh Dang, Anh-Duc Hoang Gia, Duc-Hai Nguyen, Minh-Hoa Tien, Xuan-Truong Ngo, Quang-Trung Luu, Quang-Lap Luu, Tai-Hung Nguyen, Thanh T. N. Nguyen, and Chanh Kieu. **Deep Learning Reconstruction of Tropical Cyclogenesis in the Western North Pacific from Climate Reanalysis Dataset.** arXiv:2510.06118, 2025. [https://doi.org/10.48550/arXiv.2510.06118](https://doi.org/10.48550/arXiv.2510.06118)

```bibtex
@article{le2025tcgnet,
  title   = {Deep Learning Reconstruction of Tropical Cyclogenesis in the
             Western North Pacific from Climate Reanalysis Dataset},
  author  = {Le, Duc-Trong and Dang, Tran-Binh and Hoang Gia, Anh-Duc and
             Nguyen, Duc-Hai and Tien, Minh-Hoa and Ngo, Xuan-Truong and
             Luu, Quang-Trung and Luu, Quang-Lap and Nguyen, Tai-Hung and
             Nguyen, Thanh T. N. and Kieu, Chanh},
  journal = {arXiv preprint arXiv:2510.06118},
  year    = {2025},
  doi     = {10.48550/arXiv.2510.06118},
...
For scientific questions about TCG-Net and the associated study:

- **Prof. Chanh Kieu**, Department of Earth and Atmospheric Sciences, Indiana University Bloomington — [ckieu@iu.edu](mailto:ckieu@iu.edu)
- **Dr. Duc-Trong Le**, VNU University of Engineering and Technology — [trongld@vnu.edu.vn](mailto:trongld@vnu.edu.vn)
